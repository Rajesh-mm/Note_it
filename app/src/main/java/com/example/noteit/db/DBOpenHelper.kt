...
import com.example.noteit.utils.COLUMN_NAME_DESCRIPTION
import com.example.noteit.utils.COLUMN_NAME_TITLE
import com.example.noteit.utils.TABLE_NAME
...
class DBOpenHelper(context: Context) : SQLiteOpenHelper(
    ...
    companion object {
        ...
        private const val DATABASE_NAME = "Noteit.dp"
    }
